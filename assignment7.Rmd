...
##Need to change class of Year, messing up the plot
plot1 <- merged %>%
...
##Want to add some country names
...
## ABSOLUTELY HORRIBLE WAY TO DO THIS BUT UNTIL I MANAGE OTHERWISE.....
## Should try matching part of strings of country name from each table to rename??
...
##Choropleth is saying that I'm missing more regions than are showing up in the missing dataframe??
